...
class Scurvy(magicbot.MagicRobot):
    ...
    def createMotors(self) -> None:
        ...
        # Because the robot has a component named `front_left_swerve` and that class has an attribute `drive_motor`
        # this line automatically sets the drive_motor value on the specific swerve component at the right time.
